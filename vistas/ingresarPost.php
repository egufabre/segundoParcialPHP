...
<div class="col-sx-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 form">
  <h3>COMPLETE EL POST</h3>
  <br>

<form id="formulario1" action="/altapost" method="post" >    <!-- onsubmit="return quitarEspacios()" -->

<div class="form-group">
    <label>Ingrese nombre de post:</label>
    <input type="text" class="form-control" maxlength="20" minlength="3" placeholder="Titulo" title="Mínimo de caracteres 3 y sin espacios" name="titulopost" id="titulopost" required>
</div>

<div class="form-group">
    
    <label>Ingrese cuerpo de post:</label>
    <input type="text" class="form-control" maxlength="500" minlength="3" placeholder="Cuerpo" title="Mínimo de caracteres 3 y sin espacios" name="cuerpopost" id="cuerpopost" required>
</div>
